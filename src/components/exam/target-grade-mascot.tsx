...
export function TargetGradeMascot({
  ...
  return (
    <div className="flex items-center gap-2">
      <div className="relative rounded-2xl rounded-br-none bg-orange-50 px-3 py-1.5 text-xs font-semibold text-orange-700 sm:px-4 sm:py-2 sm:text-sm lg:text-base">
        {scoreGap > 0
