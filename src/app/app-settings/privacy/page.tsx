  ...
  return (
    ...
    >
      ...
      <LegalSection title="제2조 (개인정보의 처리 및 보유 기간)">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            ...
            버전, 오류 코드 및 발생 위치를 수집일로부터 90일간 보관 후 자동
            삭제(제10조 참조)
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="제6조 (개인정보의 국외 이전)">
        <p>
          서비스는 아래와 같이 개인정보를 국외로 이전하고 있습니다. 아래 이전은
          모두 이용자와 체결한 서비스 이용계약을 이행하기 위하여 필요한 처리
          위탁에 해당합니다.
        </p>
      ...
      <LegalSection title="제10조 (자동 수집 장치의 설치·운영 및 거부)">
        ...
        <p>
          ...
          버전, 오류 코드 및 발생 위치, 오류 직전의 화면 이동 기록을 수집합니다.
          수집된 정보는 오류의 원인을 찾아 수정하는 목적으로만 이용합니다.
        </p>
        <p>
