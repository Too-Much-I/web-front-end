  ...
  return (
    ...
    >
      ...
      <LegalSection title="제3조 (처리하는 개인정보의 항목)">
        ...
        <p>
          서비스는 회원가입 절차를 두지 않으며 이름, 생년월일, 성별 등의 정보를
          수집하지 않습니다. 다만 인증 토큰은 특정 이용자의 응시 기록과 학습
          기록을 지속적으로 연결하는 식별자로 기능하므로, 서비스는 이를
          개인정보에 준하여 보호합니다.
        </p>
      </LegalSection>
      ...
      <LegalSection title="제10조 (자동 수집 장치의 설치·운영 및 거부)">
        <p>
          ...
          화면의 경로와 터치·스크롤 등 화면 조작 기록을 수집하며, 이를 세션 재생
          및 집계 형태로 제공합니다. 수집된 정보는 서비스 개선을 위한 사용성
          분석 목적으로만 사용됩니다.
        </p>
        <p>
