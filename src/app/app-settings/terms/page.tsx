...
// 시행일도 따로 관리한다. 앱 개인정보처리방침과는 같은 날짜로 맞춘다 —
// 설정 화면에서 두 문서를 나란히 보여주기 때문이다.
    ...
    >
      ...
      <LegalSection title="제5조 (서비스 이용시간 및 중단)">
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            서비스는 운영상 필요에 따라 서비스 내용의 전부 또는 일부를 사전 공지
            후 종료할 수 있습니다.
          </li>
        </ol>
      </LegalSection>
      ...
      <LegalSection title="제9조 (지식재산권)">
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            서비스는 이용자의 답변 음성을 인공지능 모델의 학습 또는 재학습
            데이터로 사용하지 않으며, 채점을 위하여 답변 음성을 전달받는 외부
            인공지능 사업자에게도 같은 조건을 요구합니다. 다만 서비스는 채점의
            정확도와 안전성을 높이기 위하여 채점의 기준·절차와 그 결과를
            검토하는 데 답변 음성과 채점 결과를 이용할 수 있으며, 이 경우에도
            이용 범위는 서비스 품질 개선 목적으로 한정됩니다.
          </li>
          <li>
