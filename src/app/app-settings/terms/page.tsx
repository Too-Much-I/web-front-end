    ...
    >
      ...
      <LegalSection title="제2조 (정의)">
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            &ldquo;학습 기록&rdquo;이란 이용자의 응시 이력, 채점 결과 및 피드백
            등 앱이 기기 또는 서버에 저장하는 이용 기록을 의미합니다.
          </li>
        </ol>
      </LegalSection>
      ...
      <LegalSection title="제6조 (학습 기록의 저장과 삭제)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            ...
            및 피드백 등의 학습 기록을 기기와 서버에 저장합니다.
          </li>
          <li>
            이용자는 앱의 설정 화면에 있는 「모든 학습 기록 삭제」를 통해 기기와
            서버에 저장된 학습 기록을 모두 직접 삭제할 수 있습니다. 삭제된 학습
            기록은 복구할 수 없습니다.
          </li>
          <li>
