...
export default function TermsOfServicePage() {
  return (
    <LegalPageLayout
      ...
      intro={
        <>
          이 약관은 토선생(이하 &ldquo;서비스&rdquo;)이 제공하는 토익 스피킹
          모의고사 및 AI 채점·피드백 서비스의 이용과 관련하여 서비스와 이용자
    ...
    >
      ...
      <LegalSection title="제2조 (정의)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            &ldquo;서비스&rdquo;란 서비스가 웹사이트를 통해 제공하는 토익 스피킹
            모의고사 응시, 음성 답변 녹음, AI 자동 채점 및 결과·피드백 제공 등
            일체의 서비스를 의미합니다.
          </li>
          <li>
          ...
          <li>
            &ldquo;답변 음성&rdquo;이란 이용자가 모의고사 응시 중 서비스를 통해
      ...
      <LegalSection title="제3조 (약관의 게시와 개정)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            서비스는 이 약관의 내용을 이용자가 알 수 있도록 서비스 초기 화면에
            게시합니다.
          </li>
          <li>
          ...
          <li>
            이용자가 개정 약관의 적용에 동의하지 않는 경우 서비스 이용을 중단할
            수 있으며, 공지 후에도 서비스를 계속 이용하는 경우 개정 약관에
            동의한 것으로 봅니다.
          </li>
        </ol>
      </LegalSection>
      ...
      <LegalSection title="제5조 (서비스 이용시간 및 중단)">
        <ol className="list-decimal space-y-1 pl-5">
          <li>
            ...
            서버 증설 및 교체, 백엔드 채점 서버의 장애 등의 사유로 서비스 제공이
            일시 중단될 수 있습니다.
          </li>
          <li>
      ...
      <LegalSection title="제6조 (이용자의 의무)">
        ...
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            자동화된 수단(매크로, 봇 등)을 이용하여 서비스에 비정상적으로 대량
            접근하거나 요청을 보내는 행위
          </li>
          <li>
            서비스의 운영을 방해하거나 서비스의 안정적인 운영을 방해할 우려가
            있는 행위
          </li>
          <li>
            서비스를 통해 취득한 문제, 채점 결과, 피드백 등을 서비스가 허용한
            범위를 벗어나 영리 목적으로 복제·배포하는 행위
          </li>
      ...
      <LegalSection title="제8조 (지식재산권)">
        <ol className="list-decimal space-y-1 pl-5">
          ...
          <li>
            ...
            있습니다. 다만 이용자는 서비스에 답변 음성을 제출함으로써 AI 채점,
            결과·피드백 제공 등 서비스 운영 목적 범위 내에서 서비스가 해당
            음성을 사용할 수 있는 권리를 부여합니다.
          </li>
          <li>
            이용자는 서비스를 이용하여 얻은 정보를 서비스의 사전 동의 없이 복제,
            송신, 출판, 배포, 방송 기타 방법으로 영리 목적으로 이용하거나
      ...
      <LegalSection title="제9조 (AI 채점 결과의 성격)">
        <p>
          ...
          TOEIC Speaking 시험 성적표 및 공인 점수가 아닙니다. 이용자는 이 점을
          이해하고 서비스를 학습 및 실전 감각 연습 목적으로 이용해야 하며,
          서비스는 AI 채점 결과와 실제 공식 시험 성적 간에 차이가 발생할 수
          있음을 안내합니다.
        </p>
      </LegalSection>
      ...
      <LegalSection title="제11조 (미성년자의 서비스 이용)">
        <p>
          ...
          법정대리인은 미성년자 이용자가 체결한 이용계약을 취소할 수 있습니다.
        </p>
      </LegalSection>
